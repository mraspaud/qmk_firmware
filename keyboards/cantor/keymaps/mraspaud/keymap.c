...
#define HRM_C MT(MOD_LGUI, KC_C)
#define HRM_S MT(MOD_LALT, KC_S)
#define HRM_N LT(L_SHIFT, KC_N)
#define HRM_T MT(MOD_LCTL, KC_T)
#define HRM_A MT(MOD_RCTL, KC_A)
#define HRM_E LT(L_SHIFT, KC_E)
#define HRM_I MT(MOD_LALT, KC_I)
#define HRM_M MT(MOD_RGUI, KC_M)
#define HRM_SC S(KC_C)
#define HRM_SS S(KC_S)
#define HRM_ST S(KC_T)
#define HRM_SA S(KC_A)
#define HRM_SI S(KC_I)
#define HRM_SM S(KC_M)
#define LT_R LT(L_NUMNAV, KC_R)
#define WD_ST C(KC_LEFT)
#define WD_ND C(KC_RIGHT)
#define LT_SYM OSL(L_SYM)
#define LT_Q LT(L_FN, KC_Q)
